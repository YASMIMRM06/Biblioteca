                ...
                <form method="POST" action="{{ route('emprestimos.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="data_emprestimo" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="date" name="data_emprestimo" value="{{ old('data_emprestimo', date('Y-m-d')) }}" required />
                        ...
                        <div>
                            ...
                            <input id="data_devolucao_prevista" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="date" name="data_devolucao_prevista" value="{{ old('data_devolucao_prevista', date('Y-m-d', strtotime('+14 days'))) }}" required />
